...
public class AnimalDAO implements GenericoDAO {
    ...
    public List<Animal> getAll() {
        ...
        try ( Connection connection = ConnectionManager.getInstance().getConnection();  Statement sentencia = connection.createStatement()) {
            ...
            ResultSet resultado = sentencia.executeQuery("SELECT id, nombre, sexo, fecha_nac, color_predominante, id_raza_predominante,"
            ...
            while (resultado.next()) {
                ...
                Animal animal = new Animal(id, nombre, sexo, fechaNac, color, raza, peso, caract);
                animales.add(animal);
            }
